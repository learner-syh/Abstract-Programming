...
STUDENT_TEST("duplicateNegatives, infinite loop,first negative"){
    Queue<int> q = {-7,8};
    Queue<int> expected = {-7, -7,8};

    duplicateNegatives(q);
    EXPECT_EQUAL(q, expected);
}

STUDENT_TEST("duplicateNegatives, infinite loop,last negative"){
    Queue<int> q = {7,-8};
    Queue<int> expected = {7, -8,-8};
